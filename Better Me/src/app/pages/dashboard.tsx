            ...
            <Link to="/orders">
              <Button variant="outline" className="w-full justify-start gap-3 h-auto py-4">
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-muted-foreground">Browse all deliveries</div>
                </div>
              </Button>
            </Link>
            ...
            <Link to="/import">
              <Button variant="outline" className="w-full justify-start gap-3 h-auto py-4">
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-muted-foreground">Bulk upload orders</div>
                </div>
              </Button>
            </Link>
            ...
            <Link to="/create">
              <Button variant="outline" className="w-full justify-start gap-3 h-auto py-4">
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-muted-foreground">Add single order</div>
                </div>
              </Button>
            </Link>
          </div>
